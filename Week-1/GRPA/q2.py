...
output5 = bool(len(str(a)) % 2 == 0 and len(str(a)) <= 10) # bool: True if a has even number of digits but not more than 10 digits

is_offer1_cheaper = (price1 - (discount1 / 100 * price1)) < (price2 - (discount2 / 100 * price2)) # bool: True if the offer1 is strictly cheaper
